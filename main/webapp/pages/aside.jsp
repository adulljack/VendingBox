	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${pageContext.request.contextPath}/user2-160x160.jpg"
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting2"><a
							href="${pageContext.request.contextPath}/goodsAdd.jsp"> <i
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cube"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting1"><a
							href="${pageContext.request.contextPath}/order/findAll/1/5">
