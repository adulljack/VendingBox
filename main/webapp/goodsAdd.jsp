...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/goods/add?goodsId=${good.goodsId}"
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="goodsId"
								placeholder="产品编号" value="${good.goodsId}">
						</div>
						<div class="col-md-2 title">商品名称</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="goodsName"
								placeholder="产品名称" value="${good.goodsName}">
						</div>
						<div class="col-md-2 title">商品价格</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="price"
								   placeholder="产品价格" value="${good.price}">
						</div>

						<div class="col-md-2 title">商品库存</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" placeholder="商品库存"
								name="number" value="${good.number}">
						</div>

						<div class="col-md-2 title">商品图片</div>
						<div class="col-md-4 data" style="width: 200px;height: 200px">
							<img id="goodimg" src="${good.imgUrl}" style="width: 100%;height: 50%">
							<input id="file" type="file" name="upload" multiple="multiple" accept="image/*">
						</div>
